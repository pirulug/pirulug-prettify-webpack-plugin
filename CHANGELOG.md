...
### Fixed
- Resolved "dangling brackets" in HTML by setting `bracketSameLine: true` and `htmlWhitespaceSensitivity: "ignore"` as defaults.
- Removed emojis from all documentation for a more professional tone.
